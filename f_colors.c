...
/*   Updated: 2019/07/03 18:54:21 by yruda            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			get_schemes(t_fractal *f, int *colors, int cs_num)
{
	...
	{
		cs[0] = (t_colscheme){COLOR1_1, COLOR1_1, COLOR1_4, COLOR1_2, COLOR1_5};
		cs[1] = (t_colscheme){COLOR2_0, COLOR2_1, COLOR2_2, COLOR2_3, COLOR2_5};
		cs[2] = (t_colscheme){COLOR3_4, COLOR3_5, COLOR3_1, COLOR3_2, COLOR3_3};
		cs[3] = (t_colscheme){COLOR4_1, COLOR4_2, COLOR4_3, COLOR4_4, COLOR4_5};
	...
	cs[0] = (t_colscheme){COLOR1_0, COLOR1_2, COLOR1_4, COLOR1_1, COLOR1_5};
	cs[1] = (t_colscheme){COLOR2_0, COLOR2_1, COLOR2_2, COLOR2_3, COLOR2_5};
	cs[2] = (t_colscheme){COLOR3_1, COLOR3_2, COLOR3_3, COLOR3_4, COLOR3_5};
	cs[3] = (t_colscheme){COLOR4_1, COLOR4_2, COLOR4_3, COLOR4_4, COLOR4_5};
	colors[0] = cs[cs_num].col0;
	colors[1] = cs[cs_num].col1;
	colors[2] = cs[cs_num].col2;
